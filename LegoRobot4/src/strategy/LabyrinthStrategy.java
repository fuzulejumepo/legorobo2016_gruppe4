...
//		this.pilot = robot.
	...
	public void execute() {
		...
		maxSpeed= Math.min(leftWheelMotor.getMaxSpeed(), rightWheelMotor.getMaxSpeed());
...
//			leftWheelMotor.rotate(-350, false);
	...
	private void moveCorrected(float speed, int factor, double distance ) {
